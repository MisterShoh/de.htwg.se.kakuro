...
class Controller @Inject() (var field: FieldInterface) extends ControllerInterface with Publisher {
  ...
  def fill(): this.type = {
    ...
    field = field.set(0, 0)
    field = field.set(0, 1, 0, 23)
    field = field.set(0, 2, 0, 30)
    field = field.set(0, 3)
    field = field.set(0, 4)
    field = field.set(0, 5, 0, 27)
    field = field.set(0, 6, 0, 12)
    field = field.set(0, 7, 0, 16)
    field = field.set(1, 0, 16, 0)
    field = field.set(1, 1, 0)
    field = field.set(1, 2, 0)
    field = field.set(1, 3)
    field = field.set(1, 4, 24, 17)
    field = field.set(1, 5, 0)
    field = field.set(1, 6, 0)
    field = field.set(1, 7, 0)
    field = field.set(2, 0, 17, 0)
    field = field.set(2, 1, 0)
    field = field.set(2, 2, 0)
    field = field.set(2, 3, 29, 15)
    field = field.set(2, 4, 0)
    field = field.set(2, 5, 0)
    field = field.set(2, 6, 0)
    field = field.set(2, 7, 0)
    field = field.set(3, 0, 35, 0)
    field = field.set(3, 1, 0)
    field = field.set(3, 2, 0)
    field = field.set(3, 3, 0)
    field = field.set(3, 4, 0)
    field = field.set(3, 5, 0)
    field = field.set(3, 6, 0, 12)
    field = field.set(3, 7)
    field = field.set(4, 0)
    field = field.set(4, 1, 7, 0)
    field = field.set(4, 2, 0)
    field = field.set(4, 3, 0)
    field = field.set(4, 4, 8, 7)
    field = field.set(4, 5, 0)
    field = field.set(4, 6, 0)
    field = field.set(4, 7, 0, 7)
    field = field.set(5, 0)
    field = field.set(5, 1, 0, 11)
    field = field.set(5, 2, 16, 10)
    field = field.set(5, 3, 0)
    field = field.set(5, 4, 0)
    field = field.set(5, 5, 0)
    field = field.set(5, 6, 0)
    field = field.set(5, 7, 0)
    field = field.set(6, 0, 21, 0)
    field = field.set(6, 1, 0)
    field = field.set(6, 2, 0)
    field = field.set(6, 3, 0)
    field = field.set(6, 4, 0)
    field = field.set(6, 5, 5, 0)
    field = field.set(6, 6, 0)
    field = field.set(6, 7, 0)
    field = field.set(7, 0, 6, 0)
    field = field.set(7, 1, 0)
    field = field.set(7, 2, 0)
    field = field.set(7, 3, 0)
    field = field.set(7, 4)
    field = field.set(7, 5, 3, 0)
    field = field.set(7, 6, 0)
    field = field.set(7, 7, 0)
    this
  }
